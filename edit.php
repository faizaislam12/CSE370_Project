...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (!isset($_GET["flight_id"])){
        header("location: /sam/index.php");
        exit;
    }

    $flight_id = $_GET["flight_id"];
    $que = "SELECT * FROM flight where flight_id = $flight_id";
    ...
    if (!$row){
        ...
        $estimated_dep_time = $row['estimated_dep_time']; 
        ...
        $to = $_POST['to'];
            ...
            $sql = "update flight set flight_number = '$flight_number',
                estimated_dep_time = '$estimated_dep_time', arr_time = '$arr_time',  
                gate = '$gate', seat = '$seat', `status` = '$status',
                `from` = '$from', `to` = '$to'    
        ...
        header("location: /sam/index.php?msg=updated");
        exit;
        }
...
<body>
    <div class="container my-5">
        ...
        <form method = "post">
            ...
            <div class = "row mb-3">
                <label class = "col-sm-3 col-form-label">Last_updated</label>
                <div class = "col-sm-6">
