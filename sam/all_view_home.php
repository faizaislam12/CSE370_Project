...
<body>
    ...
    <header>
        <nav>
            ...
            <ul>
                ...
                <!-- <li><a href="sam/bookings.php">Book</a></li>
                <li><a href="#">Manage Booking</a></li> -->
                <li><a href="all_view_flight.php">Flight Schedule</a></li>
                <li><a href="flight_track.php">Flight Track</a></li>
                <li><a href="signup_form.php">Sign In</a></li>
            </ul>
        </nav>
    </header>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <form class="search-box" action = "search1.php" method="GET">
