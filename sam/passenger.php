<?php
    ...
    $que = "SELECT * FROM passenger ORDER BY passenger_id";
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "</td>
                                <td>
                                    <div class='btn-group'>
                                        <a class='btn btn-primary btn-sm' href='edit_passenger.php?id={$row['passenger_id']}'>Edit</a>
                                        <a class='btn btn-danger btn-sm' href='delete_passenger.php?id={$row['passenger_id']}' onclick=\"return confirm('Delete this passenger record?')\">Delete</a>
                                    </div>
                                </td>
                            </tr>";
                    }
